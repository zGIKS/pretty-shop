...
export default function ProductPage({ params }: ProductPageProps) {
  ...
  const renderContent = () => {
    if (status === "loading") {
      return (
        <div className="py-16 text-center text-sm uppercase tracking-wide text-muted-foreground">
          Cargando producto...
        </div>
      );
    }
    ...
    if (status === "error" || !product) {
      return (
        <div className="py-16 text-center text-sm uppercase tracking-wide text-destructive">
